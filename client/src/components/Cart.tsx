...
export default function Cart() {
  ...
  return (
    <aside
      ...
      className={`${
        showCart
          ? "fixed top-0 right-0 z-20 bg-primary-50 w-1/5 h-screen shadow-lg transform translate-x-0 transition-transform duration-300 ease-in-out"
          : "fixed top-0 right-0 z-20 bg-primary-50 w-1/5 h-screen shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out"
      }`}
    >
      <div>
